...
@overload
def connect(str, autocommit=..., timeout=..., **kwargs) -> Connection: ...
@overload
def connect(server=..., user=...) -> Any: ...
def dataSources(*args, **kwargs): ...
def drivers(*args, **kwargs): ...
def getDecimalSeparator() -> str: ...
def setDecimalSeparator(string) -> None: ...
